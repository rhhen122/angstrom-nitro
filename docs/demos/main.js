...
function main() {
    ...
    ulist('list', '');
    ulistclose();
    input('Enter a input', 'input', '', '');
    button('Submit', '', '', 'onclick="listAdd()"');
    ...
    button('Submit', '', '', 'onclick="nameGreet()"');
}
function listAdd() {
...
function nameGreet() {
    ...
    document.getElementById('nameText').innerText = `Heyo whats up ${nameInput.value}!`;
    nameInput.value = '';
}
